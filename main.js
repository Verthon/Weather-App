...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./elements */ \"./src/js/elements.js\");\n/* harmony import */ var _scss_style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../scss/style.scss */ \"./src/scss/style.scss\");\n/* harmony import */ var _scss_style_scss__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_scss_style_scss__WEBPACK_IMPORTED_MODULE_1__);\n\n\n\nif (!navigator.geolocation) {\n  alert('Geolocation is not supported by your browser');\n}\n\nnavigator.geolocation.getCurrentPosition(success, error);\n\nfunction success(pos) {\n  //Fetch one\n  var crd = pos.coords;\n  var url = \"https://fcc-weather-api.glitch.me/api/current?lat=\".concat(crd.latitude, \"&lon=\").concat(crd.longitude);\n\n  var fetchData = function fetchData() {\n    fetch(url).then(function (data) {\n      return data.json();\n    }).then(function (data) {\n      return outputData(data);\n    });\n  };\n\n  fetchData();\n}\n\nfunction error(err) {\n  console.warn(\"ERROR(\".concat(err.code, \"): \").concat(err.message, \" \"));\n}\n\nfunction outputData(data) {\n  //Set correct city name\n  console.log(data);\n  var cityName = document.getElementById('city-name');\n  cityName.innerText = data.name; //Set correct Icon\n\n  var weatherIcon = document.getElementById('weather-icon');\n\n  switch (data.weather[0].main) {\n    case 'Clouds':\n      weatherIcon.innerText = 'D';\n      break;\n\n    case 'Rain':\n      weatherIcon.innerText = 'a';\n      break;\n\n    case 'Clear':\n      weatherIcon.innerText = 'A';\n      break;\n\n    case 'Snow':\n      weatherIcon.innerText = 'W';\n      break;\n\n    default:\n      weatherIcon.innerText = 'g';\n  } //Set description for icon\n\n\n  var iconDesc = document.getElementById('icon-desc');\n  iconDesc.innerText = data.weather[0].description; // Set correct temperature\n\n  var temperature = document.getElementById('temperature');\n  temperature.innerText = \"\".concat(data.main.temp_min.toFixed(0), \"\\xB0C\"); //Set pressure, wind speed and humidity\n\n  var cPressure = document.getElementById('pressure');\n  pressure.innerText = \"\".concat(data.main.pressure, \" hPa\");\n  var wind = document.getElementById('wind');\n  wind.innerText = \"\".concat(data.wind.speed, \" m/s\");\n  var humidity = document.getElementById('humidity');\n  humidity.innerText = \"\".concat(data.main.humidity, \" %\");\n\n  function toggleButton(name) {\n    this.element = document.getElementById(name);\n    return this.element;\n  }\n\n  var btn = new toggleButton('unit');\n  btn.addEventListener('click', function () {\n    if (btn.innerText == '°F') {\n      btn.innerText = \"\\xB0C\";\n      temperature.innerText = \"\".concat((data.main.temp_min * 1.8 + 32).toFixed(0), \"\\xB0F\");\n      return;\n    }\n\n    temperature.innerText = \"\".concat(data.main.temp_min.toFixed(0), \"\\xB0C\");\n    btn.innerText = \"\\xB0F\";\n  });\n}\n\n//# sourceURL=webpack:///./src/js/app.js?");
...
/*!****************************!*\
  !*** ./src/js/elements.js ***!
  \****************************/
/*! exports provided: temperature, cityName, weatherIcon, iconDesc, wind, humidity */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
